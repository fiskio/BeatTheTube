...
public class GMapV2Direction {
    ...
    private static final String TAG = GMapV2Direction.class.getSimpleName();
    ...
    public Document getDocument(String startPostcode, String endPostcode, String mode) {
    ...
    public LatLng getStartLocation(Document doc) {
        ...
        Log.i("StartLocation", locationNode.getTextContent());
        NodeList nl2 = locationNode.getChildNodes();
        Node latNode = nl2.item(getNodeIndex(nl2, "lat"));
        double latitude = Double.parseDouble(latNode.getTextContent());
        Node lngNode = nl2.item(getNodeIndex(nl2, "lng"));
        double longitude = Double.parseDouble(lngNode.getTextContent());
        return new LatLng(latitude, longitude);
    }
    
    public LatLng getEndLocation(Document doc) {
        NodeList nl1 = doc.getElementsByTagName("end_location");
        int lastIndex = nl1.getLength()-1;
        Node locationNode = nl1.item(lastIndex);
        Log.i("EndLocation", locationNode.getTextContent());
        NodeList nl2 = locationNode.getChildNodes();
        Node latNode = nl2.item(getNodeIndex(nl2, "lat"));
        double latitude = Double.parseDouble(latNode.getTextContent());
        Node lngNode = nl2.item(getNodeIndex(nl2, "lng"));
